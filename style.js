(function (blink) {
	...
	var piedrasantademoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	piedrasantademoStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_piedrasantademo',
		ckEditorStyles: {
			name: 'piedrasantademo',
			styles: [
	...
	piedrasantademoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), piedrasantademoStyle.prototype);

	blink.theme.styles.piedrasantademo = piedrasantademoStyle;
